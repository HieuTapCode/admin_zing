...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th10 17, 2024 lúc 08:54 AM
...
CREATE TABLE `admin` (
  ...
  `sodienthoai` bigint(10) NOT NULL
...
INSERT INTO `admin` (`id_user`, `user_name`, `account_name`, `password`, `email`, `sodienthoai`) VALUES
(1, 'admin', 'admin', 'admin123', 'nguyentronghieu@gmail.com', 372212125);
...
--
-- Cấu trúc bảng cho bảng `history_list`
--

CREATE TABLE `history_list` (
  `history_list_id` int(11) NOT NULL,
  `user_id` int(11) DEFAULT NULL,
  `song_id` int(11) DEFAULT NULL,
...
--
-- Đang đổ dữ liệu cho bảng `history_list`
--

INSERT INTO `history_list` (`history_list_id`, `user_id`, `song_id`, `kindof`, `title_artist`, `created_at`) VALUES
(16, 4, 15, 'EDM', 'MR T X YANBI X HẰNG BINGBOONG ft. NIN HOÀNG & BIBO REMIX', '2024-09-06 19:52:36'),
(20, 4, 19, 'EDM', 'Dunghoangpham & Exclusive Music', '2024-09-06 20:04:24'),
(21, 4, 12, 'EDM', 'TBynz Remix', '2024-09-06 20:08:49'),
(22, 4, 14, 'EDM', 'NAMINO REMIX', '2024-09-06 20:14:03'),
(23, 4, 17, 'EDM', 'Hieii Remix ft.Thomas Xynh', '2024-09-06 20:17:53'),
(24, 4, 44, 'EDM', 'Bình Hồ Remix', '2024-09-06 20:19:03'),
(25, 4, 11, 'EDM', 'THÁI HOÀNG REMIX', '2024-09-06 20:20:02'),
(26, 1, 40, 'EDM', 'Frexs Remix', '2024-09-21 16:21:13'),
(27, 5, 38, 'EDM', 'Diệu Khiên x AN Remix', '2024-09-21 16:25:08'),
(28, 10, 1, 'EDM', 'BT REMIX', '2024-09-21 16:37:07'),
(29, 10, 46, 'EDM', 'DJ Thái Hoàng', '2024-09-21 16:42:46'),
(30, 10, 43, 'EDM', 'Quyền Hải Phòng X Tuấn Hưng Remix', '2024-09-21 16:43:15'),
(31, 10, 19, 'EDM', 'Dunghoangpham & Exclusive Music', '2024-09-21 16:43:46'),
(32, 10, 17, 'EDM', 'Hieii Remix ft.Thomas Xynh', '2024-09-21 16:44:43'),
(33, 10, 38, 'EDM', 'Diệu Khiên x AN Remix', '2024-09-21 16:45:29'),
(34, 10, 40, 'EDM', 'Frexs Remix', '2024-09-21 16:47:32'),
(35, 10, 14, 'EDM', 'NAMINO REMIX', '2024-09-21 16:49:01'),
(36, 10, 45, 'EDM', 'Thùy Chi (DANGLING)', '2024-09-21 16:53:49'),
(37, 5, 2, 'EDM', 'THEREON REMIX', '2024-09-26 05:58:01'),
(38, 11, 42, 'EDM', 'Orange - (KAIFO Remix)', '2024-09-27 14:54:53'),
(39, 11, 38, 'EDM', 'Diệu Khiên x AN Remix', '2024-09-27 14:56:32'),
(40, 11, 47, 'EDM', 'MrSiro - Nb Remix', '2024-09-27 14:57:25'),
(41, NULL, 46, 'EDM', 'DJ Thái Hoàng', '2024-09-28 17:55:30'),
(42, NULL, 17, 'EDM', 'Hieii Remix ft.Thomas Xynh', '2024-09-28 17:59:23'),
(43, NULL, 46, 'EDM', 'DJ Thái Hoàng', '2024-09-28 17:59:43'),
(44, 5, 32, 'Trap', 'JAPAN Remix ', '2024-09-28 18:00:47');

--
-- Bẫy `history_list`
--
DELIMITER $$
CREATE TRIGGER `trg_limit_history_list` AFTER INSERT ON `history_list` FOR EACH ROW BEGIN
...
INSERT INTO `payment` (`payment_id`, `id_user`, `txn_ref`, `amount`, `order_info`, `response_code`, `transaction_no`, `bank_code`, `pay_date`, `status`, `created_at`) VALUES
(13, 5, '9847', 100000, 'Thanh toan GD:9847', '00', '14597197', 'NCB', '2024-09-29 00:16:02', 'success', '2024-09-28 17:17:18'),
(14, 10, '2108', 100000, 'Thanh toan GD:2108', '00', '14597199', 'NCB', '2024-09-29 00:19:44', 'success', '2024-09-28 17:19:02'),
(15, 11, '4474', 100000, 'Thanh toan GD:4474', '00', '14597201', 'NCB', '2024-09-29 00:21:32', 'success', '2024-09-28 17:20:48'),
(16, 13, '2873', 100000, 'Thanh toan GD:2873', '00', '14599782', 'NCB', '2024-10-02 00:00:51', 'success', '2024-10-01 17:00:07'),
(17, 12, '4246', 100000, 'Thanh toan GD:4246', '00', '14603565', 'NCB', '2024-10-05 11:02:07', 'success', '2024-10-05 04:01:41'),
(18, 14, '2315', 100000, 'Thanh toan GD:2315', '00', '14604594', 'NCB', '2024-05-14 00:17:37', 'success', '2024-10-06 17:17:22'),
(19, 15, '9807', 100000, 'Thanh toan GD:9807', '00', '14604597', 'NCB', '2024-01-04 00:20:11', 'success', '2024-10-06 17:20:00'),
(20, 4, '3012', 100000, 'Thanh toan GD:3012', '00', '14604598', 'NCB', '2024-08-20 00:22:12', 'success', '2024-10-06 17:21:46'),
(21, 3, '503', 100000, 'Thanh toan GD:503', '00', '14604599', 'NCB', '2024-04-10 00:23:54', 'success', '2024-10-06 17:23:28'),
(22, 2, '7539', 100000, 'Thanh toan GD:7539', '00', '14604600', 'NCB', '2024-03-12 00:25:26', 'success', '2024-10-06 17:24:59'),
(23, 1, '9881', 100000, 'Thanh toan GD:9881', '00', '14604601', 'NCB', '2024-04-08 00:26:50', 'success', '2024-10-06 17:26:25'),
(24, 16, '9696', 100000, 'Thanh toan GD:9696', '00', '14605611', 'NCB', '2024-09-26 20:37:01', 'success', '2024-10-07 13:36:36'),
(25, 17, '6348', 100000, 'Thanh toan GD:6348', '00', '14605613', 'NCB', '2024-07-10 20:37:36', 'success', '2024-10-07 13:37:10'),
(26, 18, '5518', 100000, 'Thanh toan GD:5518', '00', '14605614', 'NCB', '2024-11-14 20:38:06', 'success', '2024-10-07 13:37:41'),
(27, 19, '7989', 100000, 'Thanh toan GD:7989', '00', '14605622', 'NCB', '2024-09-05 20:49:31', 'success', '2024-10-07 13:49:06'),
(28, 20, '9479', 100000, 'Thanh toan GD:9479', '00', '14605624', 'NCB', '2024-07-19 20:50:01', 'success', '2024-10-07 13:49:36'),
(29, 21, '7190', 100000, 'Thanh toan GD:7190', '00', '14605627', 'NCB', '2024-02-26 20:53:37', 'success', '2024-10-07 13:53:12'),
(30, 23, '8900', 100000, 'Thanh toan GD:8900', '00', '14605628', 'NCB', '2024-02-16 20:54:15', 'success', '2024-10-07 13:53:49'),
(31, 22, '6538', 100000, 'Thanh toan GD:6538', '00', '14605633', 'NCB', '2024-02-06 20:56:14', 'success', '2024-10-07 13:55:49');
...
--
DELIMITER $$
CREATE TRIGGER `trg_limit_search_history` AFTER INSERT ON `search_history` FOR EACH ROW BEGIN
...
(14, 3, 1, 'NAMINO REMIX', 'Cho Em Gần Anh Thêm Chút Nữa Remix ', 'https://res.cloudinary.com/dnhps1jbn/image/upload/v1695635279/song_thumbnail/artworks-000311128110-1x9wq1-t500x500.jpg.jpg', 'https://res.cloudinary.com/dnhps1jbn/video/upload/v1695635654/audio/df.mp3.mp3', '2024-08-20 11:54:16', '3:44', 12, 1, 'free', 'EDM'),
...
(17, 3, 1, 'Hieii Remix ft.Thomas Xynh', 'Về Đây Em Lo Remix', 'https://res.cloudinary.com/dnhps1jbn/image/upload/v1695860788/song_thumbnail/vedayemlo.jpg', 'https://res.cloudinary.com/dnhps1jbn/video/upload/v1695637068/audio/y2mate.com%20-%20V%E1%BB%81%20%C4%90%C3%A2y%20Em%20Lo%20Hieii%20remix%20HOT%20TIKTOK_320kbps.mp3.mp3', '2024-08-20 12:17:49', '1:08', 16, 0, 'free', 'EDM'),
(19, 3, 1, 'Dunghoangpham & Exclusive Music', 'Mật Ngọt (Nam Con Remix)', 'https://res.cloudinary.com/dnhps1jbn/image/upload/v1695637508/song_thumbnail/artworks-uLUnnW6h3gKIFXpc-pF0p5w-t500x500.jpg.jpg', 'https://res.cloudinary.com/dnhps1jbn/video/upload/v1695637515/audio/g.mp3.mp3', '2024-08-20 12:25:17', '4:24', 4, 0, 'free', 'EDM'),
...
(32, 5, 3, 'JAPAN Remix ', 'Wolves Remix', 'https://res.cloudinary.com/dnhps1jbn/image/upload/v1695696489/song_thumbnail/volve_remix.jpg', 'https://res.cloudinary.com/dnhps1jbn/video/upload/v1695696494/audio/sda.mp3.mp3', '2024-08-20 04:48:15', '4:53', 1, 0, 'vip', 'Trap'),
...
(42, 3, 1, 'Orange - (KAIFO Remix)', 'Em Hát Ai Nghe ', 'https://res.cloudinary.com/dnhps1jbn/image/upload/v1695866226/song_thumbnail/Em%20H%C3%A1t%20Ai%20Nghe%20in3byOrange%20-%20%28KAIFO%20Remix%29.jpg', 'https://res.cloudinary.com/dnhps1jbn/video/upload/v1695866230/audio/SaveTik.co_7261266180290153733.mp3byOrange%20-%20%28KAIFO%20Remix%29in3.mp3', '2024-08-20 03:57:12', '1:07', 4, 0, 'free', 'EDM'),
(43, 3, 1, 'Quyền Hải Phòng X Tuấn Hưng Remix', 'Phải Chia Tay Thôi', 'https://res.cloudinary.com/dnhps1jbn/image/upload/v1695866432/song_thumbnail/Ph%E1%BA%A3i%20Chia%20Tay%20Th%C3%B4iin3byQuy%E1%BB%81n%20H%E1%BA%A3i%20Ph%C3%B2ng%20X%20Tu%E1%BA%A5n%20H%C6%B0ng%20Remix.jpg', 'https://res.cloudinary.com/dnhps1jbn/video/upload/v1695866436/audio/SaveTik.co_7243109707798301957.mp3byQuy%E1%BB%81n%20H%E1%BA%A3i%20Ph%C3%B2ng%20X%20Tu%E1%BA%A5n%20H%C6%B0ng%20Remixin3.mp3', '2024-08-20 04:00:38', '0:59', 4, 0, 'free', 'EDM'),
...
(1, 'Dương Văn Mạnh', 'manhduong2953', 'manhme62', 'https://res.cloudinary.com/dnhps1jbn/image/upload/v1695528696/avatar_link/Hinh-anh-chan-dung-nam-dep-nghe-thuat-400x600.jpg.jpg', 'vip', 1),
(2, 'Trần Thúy Lan', 'locnguyen99', '123', 'https://res.cloudinary.com/dnhps1jbn/image/upload/v1695694118/avatar_link/Hinh-anh-chan-dung-nu-400x600.jpg.jpg', 'vip', 0),
(3, 'Trần Đức Vỹ', 'ducvy123', '123', 'https://res.cloudinary.com/dnhps1jbn/image/upload/v1695695553/avatar_link/Hinh-anh-chan-dung-nam-400x600.jpg.jpg', 'vip', 0),
(4, 'Tiêu Công Hiệp', 'manhduong64', '123', 'https://static2.yan.vn/YanNews/2167221/202003/dan-mang-du-trend-thiet-ke-avatar-du-kieu-day-mau-sac-tu-anh-mac-dinh-b0de2bad.jpg', 'vip', 0),
(5, 'Nguyễn Trọng Hiếu', 'nguyenhieu', 'hieu2003', 'https://res.cloudinary.com/dnhps1jbn/image/upload/v1727544243/avatar_link/Nguy%E1%BB%85n%20Tr%E1%BB%8Dng%20Hi%E1%BA%BFunguyenhieu.png', 'vip', 1),
(10, 'test', 'test', 'tet123', 'https://static2.yan.vn/YanNews/2167221/202003/dan-mang-du-trend-thiet-ke-avatar-du-kieu-day-mau-sac-tu-anh-mac-dinh-b0de2bad.jpg', 'vip', 0),
(11, 'phong', 'phong', '123', '', 'vip', 0),
(12, 'phu', 'phu', '123', '', 'vip', 0),
(13, 'lan', 'lan', '1234', 'https://static2.yan.vn/YanNews/2167221/202003/dan-mang-du-trend-thiet-ke-avatar-du-kieu-day-mau-sac-tu-anh-mac-dinh-b0de2bad.jpg', 'vip', 0),
(14, 'datnguyen', 'dat', '123', 'https://static2.yan.vn/YanNews/2167221/202003/dan-mang-du-trend-thiet-ke-avatar-du-kieu-day-mau-sac-tu-anh-mac-dinh-b0de2bad.jpg', 'vip', 0),
(15, 'hieudz', 'hieu', '123', 'https://static2.yan.vn/YanNews/2167221/202003/dan-mang-du-trend-thiet-ke-avatar-du-kieu-day-mau-sac-tu-anh-mac-dinh-b0de2bad.jpg', 'vip', 0),
(16, 'ten', 'ten', '123', '', 'vip', 0),
(17, 'hung', 'hung', '123', '', 'vip', 0),
(18, 'ha', 'ha', '123', '', 'vip', 0),
(19, 'linh', 'linh', '123', '', 'vip', 0),
(20, 'mai', 'mai', '123', '', 'vip', 0),
(21, 'quan', 'quan', '123', '', 'vip', 0),
(22, 'tuan', 'tuan', '123', '', 'vip', 0),
(23, 'anh', 'anh', '123', '', 'vip', 0),
(24, 'phuong', 'phuong', '123', '', 'free', 0);
...
--
-- Chỉ mục cho bảng `history_list`
--
ALTER TABLE `history_list`
  ADD PRIMARY KEY (`history_list_id`);
...
--
ALTER TABLE `favorite_list`
  MODIFY `favorite_list_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;

--
-- AUTO_INCREMENT cho bảng `history_list`
--
ALTER TABLE `history_list`
  MODIFY `history_list_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=45;
...
--
ALTER TABLE `song`
  MODIFY `song_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=69;
...
--
ALTER TABLE `album`
  ADD CONSTRAINT `album_ibfk_1` FOREIGN KEY (`artist_id`) REFERENCES `user` (`id_user`) ON DELETE SET NULL ON UPDATE CASCADE;

--
-- Các ràng buộc cho bảng `favorite_list`
--
ALTER TABLE `favorite_list`
  ADD CONSTRAINT `favorite_list_ibfk_1` FOREIGN KEY (`song_id`) REFERENCES `song` (`song_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `favorite_list_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `user` (`id_user`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `search_history`
  ADD CONSTRAINT `search_history_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `user` (`id_user`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `song`
  ...
  ADD CONSTRAINT `song_ibfk_2` FOREIGN KEY (`artist_id`) REFERENCES `user` (`id_user`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
